...
- Deploys **Firefox extension policies** (DarkReader, FoxyProxy, uBlock Origin, Wappalyzer) and Burp Suite extras (JRuby/Jython JARs)
...
| `browser` | Firefox policies (DarkReader, FoxyProxy, uBlock Origin, Wappalyzer), Burp JRuby/Jython JARs |
